                ...
                <div class="card text-green" style="border-radius: 1rem;">
                    <div class="card-body p-2 text-center">
                        <div class="mb-md-2 mt-md-1 pb-2">
                            ...
                            <p class=" mb-5">Iltimos shaxsiy malumotlaringizni kiriting!</p>
                            ...
                            <button class="btn btn-lg px-5" type="submit">Ro'yxatdan o'tish</button>
                            </form>
                        </div>
                        <div>
                            <p class="mb-0">Shaxsiy profilingiz bormi? <a href="{{route('user.login')}}" class="fw-bold">Kirish</a>
                            </p>
                        </div>
